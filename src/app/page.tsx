    ...
    <main className={styles.main}>
      ...
      >
        <Paragraph>
          ...
          envisioning and creating cutting-edge web applications in the fintech
          and SaaS sectors. I lead a team of talented developers, setting
          strategic directions, and fostering a culture of innovation.
      ...
      >
        <Paragraph>
          ...
          development course, drawing from my rich experience. Beyond teaching,
          I developed the academy&apos;s website and implemented automated
          processes to enhance the learning experience. This role allowed me to
          shape the next generation of developers, many of whom have become key
          contributors in the tech industry.
        </Paragraph>
      </Work>
      <Divider />
      <Work
      ...
      >
        <Paragraph>
          ...
          actively supported students in their practical projects, helping them
      ...
      >
        <Paragraph>
          ...
          worked on various projects, leveraging a wide array of technologies to
          deliver tailored front-end solutions. This period honed my skills in
          project management, client communication, and staying ahead of the
          curve in rapidly evolving tech trends.
        </Paragraph>
        <Fullwidth>
          <Project
            title="Generator"
